...
export default function ScrollToTopButton() {
  ...
  return (
    <div
      className={`fixed bottom-8 right-8 bg-orange-900 text-white rounded-full w-12 h-12 flex items-center justify-center shadow-lg transition-opacity duration-400 ease-in-out ${
